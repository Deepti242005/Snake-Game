...
canvas=tkinter.Canvas(window,bg="black",width=window_width,height=window_height,borderwidth=10,highlightthickness=10)
canvas.pack()
window.update()

#To get window measurements
window_width=window.winfo_width()
window_height=window.winfo_height()

#To get the screen measurements
